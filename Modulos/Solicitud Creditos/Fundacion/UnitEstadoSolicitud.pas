...
uses UnitDmSolicitud, UnitImpresion, UnitPrIncipal;
...
begin
          ...
          begin
            ...
            imprimir_reporte(FrMain.wpath+'reportes\repestadosol.frf');
          end
          else
          begin
            IBtotal.Close;
            ...
            IBQuery1.Close;
            IBQuery1.ParamByName('FECHA_INI').AsDateTime := DTfechaini.DateTime;
            IBQuery1.ParamByName('FECHA_FIN').AsDateTime := DTfechafin.DateTime;
            IBQuery1.Open;
            imprimir_reporte(FrMain.wpath+'reportes\repestadosoltotal.frf');
          end;
