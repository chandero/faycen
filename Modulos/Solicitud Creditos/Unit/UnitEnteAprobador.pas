...
begin
        ...
        begin
          ...
          Transaction.StartTransaction;
          SQL.Clear;
          SQL.Add('select "col$solicitud".ESTADO,"col$estadosolicitud".DESCRIPCION_ESTADO from "col$solicitud"');
          SQL.Add('INNER JOIN "col$estadosolicitud" ON ("col$solicitud".ESTADO = "col$estadosolicitud".ID_ESTADO)');
          SQL.Add('where ID_SOLICITUD = :ID_SOLICITUD');
          ...
          if RecordCount <> 0 then
          begin
            if FieldByName('ESTADO').AsInteger = 8 then
               DBente.KeyValue := 3
