...
uses
  ...
  ToolWin, unitdmGeneral, ExtCtrls, DateUtils, IBSQL, IdBaseComponent,
  IdComponent, IdTCPConnection, IdTCPClient, IdTime;
...
type
  TfrmMain = class(TForm)
    ...
    MantenimientodeTercero1: TMenuItem;
    MantenimientodeDescuentos1: TMenuItem;
    DescuentosporLibranza1: TMenuItem;
    Mensuales1: TMenuItem;
    AplicarDescuentodeNomina1: TMenuItem;
    Cartera1: TMenuItem;
    ConsultaCartera1: TMenuItem;
    LiquidacinNormal1: TMenuItem;
    LiquidacinManual1: TMenuItem;
    RecaudoProyectadoCaja1: TMenuItem;
    Creditos1: TMenuItem;
    FormulariodeSolicitud1: TMenuItem;
    DesembolsodeCrdito1: TMenuItem;
    VisarCrdito1: TMenuItem;
    MantenimientodeProveedores1: TMenuItem;
    N15: TMenuItem;
    N18: TMenuItem;
    ConsultadeComprobantes1: TMenuItem;
    ExtractoAsociado1: TMenuItem;
    ...
    procedure MantenimientodeTercero1Click(Sender: TObject);
    procedure MantenimientodeDescuentos1Click(Sender: TObject);
    procedure DescuentosporLibranza1Click(Sender: TObject);
    procedure AplicarDescuentodeNomina1Click(Sender: TObject);
    procedure FormulariodeSolicitud1Click(Sender: TObject);
    procedure DesembolsodeCrdito1Click(Sender: TObject);
    procedure VisarCrdito1Click(Sender: TObject);
    procedure LiquidacinManual1Click(Sender: TObject);
    procedure RecaudoProyectadoCaja1Click(Sender: TObject);
    procedure MantenimientodeProveedores1Click(Sender: TObject);
    procedure ConsultadeComprobantes1Click(Sender: TObject);
...
begin
  ...
  try
    ...
    Descripcion_Empresa := ReadString('EMPRESA','description',Empresa);
    Telefono:= ReadString('EMPRESA','phone','');
    Movil := ReadString('EMPRESA','mobil','');
...
begin
        Self.Caption := 'Módulo Contable - ' + DBserver + ' - ' + Empresa;
        if SalirMal then
           Self.Close;
end;
...
procedure TfrmMain.MantenimientodeTercero1Click(Sender: TObject);
var
  frmGestionTercero: TfrmGestionTercero;
begin
       frmGestionTercero := TfrmGestionTercero.Create(self);
       frmGestionTercero.ShowModal;
end;

procedure TfrmMain.MantenimientodeDescuentos1Click(Sender: TObject);
var
   frmMantenimientoDescuentos: TfrmMantenimientoDescuentos;
begin
       frmMantenimientoDescuentos := TfrmMantenimientoDescuentos.Create(self);
       frmMantenimientoDescuentos.ShowModal;
end;

procedure TfrmMain.DescuentosporLibranza1Click(Sender: TObject);
var
        frmCausacionCarteraYOtros : TfrmCausacionCarterayOtros;
begin
        frmCausacionCarteraYOtros := TfrmCausacionCarterayOtros.Create(self);
        frmCausacionCarteraYOtros.ShowModal;
end;

procedure TfrmMain.AplicarDescuentodeNomina1Click(Sender: TObject);
var
  frmAplicarDescuentosLibranza: TfrmAplicarDescuentosLibranza;
begin
     frmAplicarDescuentosLibranza := TfrmAplicarDescuentosLibranza.Create(self);
     frmAplicarDescuentosLibranza.ShowModal;
end;

procedure TfrmMain.FormulariodeSolicitud1Click(Sender: TObject);
begin
...
procedure TfrmMain.RecaudoProyectadoCaja1Click(Sender: TObject);
var
...
begin
         frmExtractoAsociado := TfrmExtractoAsociado.Create(self);
         frmExtractoAsociado.ShowModal;
end;

procedure TfrmMain.AuxiliarTercero1Click(Sender: TObject);
var
   frmAuxiliarTercero: TfrmAuxiliarTercero;
begin
      frmAuxiliarTercero := TfrmAuxiliarTercero.Create(self);
      frmAuxiliarTercero.ShowModal;
end;

procedure TfrmMain.CausacinInteresesdeDepositos1Click(Sender: TObject);
var
