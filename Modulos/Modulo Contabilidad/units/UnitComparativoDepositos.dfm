object frmComparativoDepositos: TfrmComparativoDepositos
  ...
  object CDSdatos: TClientDataSet
    ...
    Top = 104
    Data = {
      BC0000009619E0BD010000001800000005000000000003000000BC000A49445F
      ...
      0100490000000100055749445448020002006400084445504F5349544F080004
      000000010007535542545950450200490006004D6F6E65790008434F4E544142
      4C45080004000000010007535542545950450200490006004D6F6E6579000000}
    ...
    object CDSdatosDEPOSITO: TCurrencyField
      DisplayWidth = 12
      FieldName = 'DEPOSITO'
    end
  ...
  object IBQproducto: TIBQuery
    SQL.Strings = (
      'SELECT * FROM "cap$tipocaptacion" ORDER BY ID_TIPO_CAPTACION')
    Left = 208
    Top = 8
  end
