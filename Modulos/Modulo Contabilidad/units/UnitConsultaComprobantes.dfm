object frmConsultaComprobantes: TfrmConsultaComprobantes
  ...
  object IBQtipocomprobante: TIBQuery
    ...
    AfterScroll = IBQtipocomprobanteAfterScroll
    SQL.Strings = (
  ...
  object IBQcomprobante: TIBQuery
    ...
    SQL.Strings = (
        ...
        'SELECT * FROM "con$comprobante"  WHERE TIPO_COMPROBANTE = :TIPO_' +
        'COMPROBANTE'
  ...
  object IBAuxiliar: TIBQuery
    ...
    SQL.Strings = (
      ...
      '"con$comprobante"'
        ...
        'where            ("con$comprobante".ID_COMPROBANTE = :"ID_COMPRO' +
        'BANTE" ) and ("con$comprobante".TIPO_COMPROBANTE = :"TIPO_COMPRO' +
        'BANTE")'
