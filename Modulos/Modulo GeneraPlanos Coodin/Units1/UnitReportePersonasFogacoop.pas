...
begin
    ...
    AssignFile(Archivo,'C:/PlanosFinMes/PERSONAS' + Cadena);
    Rewrite(Archivo);
    ...
    frmProgreso.Min := 0;
        with IBSQL1 do begin
          ...
          SQL.Add(' WHERE');
          SQL.Add('  "cap$maestro".FECHA_APERTURA BETWEEN :FECHA1 and :FECHA2');
          ...
          SQL.Add(' WHERE');
          SQL.Add('  "cap$maestro".FECHA_APERTURA BETWEEN :FECHA1 and :FECHA2 and "gen$direccion".ID_DIRECCION = 1');
          ParamByName('FECHA1').AsDate := EdFechaCorte1.Date;
          ParamByName('FECHA2').AsDate := EdFechaCorte2.Date;
          try
           ExecQuery;
