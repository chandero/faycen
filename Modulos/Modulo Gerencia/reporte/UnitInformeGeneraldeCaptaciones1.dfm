object frmInformeGeneraldeCaptaciones: TfrmInformeGeneraldeCaptaciones
  ...
  object CdJuvenil: TClientDataSet
    ...
    object CdJuvenilID_TIPO_CAPTACION: TIntegerField
    ...
    object CdJuvenilDEUDA: TStringField
      FieldName = 'DEUDA'
      Size = 2
    end
    ...
    object CdJuvenilAPORTES: TCurrencyField
      FieldName = 'APORTES'
    end
    object CdJuvenilAHORROS: TCurrencyField
      FieldName = 'AHORROS'
    end
    object CdJuvenilJUVENIL: TCurrencyField
      FieldName = 'JUVENIL'
    end
    object CdJuvenilACTIVO: TStringField
      FieldName = 'ACTIVO'
      Size = 10
    end
  end
  ...
  object CdMayor: TClientDataSet
    ...
    Top = 24
    Data = {
      
        ...
        object prTxMemoObj24: TprTxMemoObj
          ...
          dRec.Versions = <
            item
              Visible = True
              Memo.Strings = (
                '[CDMayor.EDAD]-[:<yyyy/mm/dd>FECHAN]')
              DeleteEmptyLinesAtEnd = False
              DeleteEmptyLines = False
              CanResizeX = False
              CanResizeY = False
