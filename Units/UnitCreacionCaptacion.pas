...
begin
         ...
         begin
           Consecutivo := EdNumeroAportacion.Value;
         end;
         ...
         begin
                ...
                ParamByName('NUMERO_CUENTA').AsInteger := EdNumeroAportacion.Value;
...
procedure TfrmCreacionCaptacion.EdNumeroAportacionExit(Sender: TObject);
begin
        if (EdNumeroAportacion.Value > 0) then
        EdDigitoAportacion.Caption := DigitoControl(1,FormatFloat('0000000',EdNumeroAportacion.Value));
end;
