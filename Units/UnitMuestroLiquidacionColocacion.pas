...
type
  ...
  private
    ...
    MyAbonoAportes:Currency;
    MyAbonoDescuento:Currency;
    MyBaseGMF:Currency;
  ...
  public
    ...
    property AbonoAportes:Currency read MyAbonoAportes Write MyAbonoAportes;
    property AbonoDescuento:Currency read MyAbonoDescuento Write MyAbonoDescuento;
    ...
    if AbonoAportes > 0  then begin
      with IBQuery1 do
       begin
         ...
         ParamByName('FECHA_MOVIMIENTO').AsDateTime := FechaNota; //fFechaActual;
         ...
         ParamByName('DESCRIPCION_MOVIMIENTO').AsString := 'ABONO CUOTA DE APORTE EN LA FECHA';
         ParamByName('VALOR_DEBITO').AsCurrency := AbonoAportes;
