object frmCalculoCuotadePrueba: TfrmCalculoCuotadePrueba
  ...
  object GroupBox3: TGroupBox
    ...
    object EdAportes: TJvCurrencyEdit
      Left = 410
      Top = 101
      Width = 136
      Height = 21
    ...
    object EdDescuento: TJvCurrencyEdit
      Left = 410
      Top = 125
      Width = 136
      Height = 21
  ...
  object IBQuery3: TIBQuery
    ...
    SQL.Strings = (
        ...
        'select * from "gen$bancosconnal"  where ID_BANCO > 0 order by ID' +
        '_BANCO ASC')
    Left = 284
    Top = 513
  end
