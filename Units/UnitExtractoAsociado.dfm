object frmExtractoAsociado: TfrmExtractoAsociado
  ...
  object IBQcartera: TIBQuery
    SQL.Strings = (
      ...
      ' ("c".FECHA_DESEMBOLSO <= :FECHA_CORTE)'
      'ORDER BY'
      '  "l".ID_LINEA,'
      '  "c".ID_COLOCACION')
    Left = 216
  ...
  object IBQdescuentocartera: TIBQuery
    SQL.Strings = (
      'SELECT'
      ...
      '  d.FECHA_CORTE'
      'FROM'
      ' GEN$DESCUENTOCARTERA d'
      'WHERE'
      ' d.ID_COLOCACION = :ID_COLOCACION'
      'AND'
  ...
  object IBQcarteraOLD: TIBQuery
    SQL.Strings = (
      ...
      ' "col$colocacion" "c"'
        ...
        ' LEFT JOIN GEN$DESCUENTOCARTERA "d" ON ("c".ID_COLOCACION="d".ID' +
        '_COLOCACION) '
      ' INNER JOIN "col$lineas" "l" ON ("c".ID_LINEA="l".ID_LINEA)'
